...
puts "Your trip will take " + time.round(1).to_s + " hours and cost $" + total.round.(2).to_s + "."
...
puts "Press 3 for mortgage calculator"
puts "Press Q to quit"

select = gets.chomp

until select == "1" || select == "2" || select == "3" || select == "Q"
